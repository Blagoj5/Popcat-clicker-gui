...
exports.popScript = void 0;
var puppeteer_1 = __importDefault(require("puppeteer"));
var popScript = function (headless) {
    if (headless === void 0) { headless = false; }
    return __awaiter(void 0, void 0, void 0, function () {
        var browser, page, startDate, span, i, finishDate, text, timesClicked, clicks;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 10:
                    ...
                    if (timesClicked) {
                        clicks = document.createTextNode((i * 5).toString());
                        timesClicked.appendChild(clicks);
                        timesClicked.style.display = 'block';
                    }
                    return [4, page.screenshot({ path: 'dokaz.png' })];
                case 11:
                    _a.sent();
